...
if __name__ == "__main__":
    ...
    def play_a_game_alphaBeta_random(game,max_depth):
        ...
        while True:
            if game.current_player == 1:
                best_move, _ = iterative_deepening(game, max_depth, alpha_beta_player=game.current_player, time_limit=1000000)
                if not best_move:
                    break
    ...
    def play_a_game_mcts3_random(game):
        ...
        while True:
            if game.current_player == 1:
                best_move = mcts3(game, is_to_move=game.current_player, time_limit=60)
        ...
        # Player 1: Random Moves | Player 2: mcts3.py
    def play_a_game_random_mcts3(game):
        count = 0
        while True:
            if game.current_player == 1:
                all_legal_moves = game.current_player_has_legal_moves()
                if not all_legal_moves:
                    break
                move = random.choice(all_legal_moves)
                print("Move Spieler 1 (RANDOM): ", move)
                game.make_move(*move)
                game.current_player = 2
                print("EVAL SPIELER 1: ",game.evaluate_position())
                count += 1
                ...
                if not best_move:
                    break
                print("Move Spieler 2 (MCTS): ", best_move)
                game.make_move(*best_move)
                game.current_player = 1
                print("EVAL SPIELER 2: ",game.evaluate_position())
                count += 1
    ...
    def play_a_game_mtdf_random(game, max_depth):
        count = 0
        while True:
            if game.current_player == 1:
                best_move = iterative_deepening_mtdf(game, max_depth, alpha_beta_player=game.current_player, time_limit=1000000)
                if not best_move:
                    break
                print("Move Spieler 1 (MTD(f)): ",best_move)
                game.make_move(*best_move)
                game.current_player = 2
                print("EVAL SPIELER 1: ",game.evaluate_position())
                count += 1
    ...
    # ------------ MCTS VS PVS ------------
    def play_game_mcts_pvs(game, time_limit = 60):
        time_limit = time_limit
        # abwechselnd mcts3 und pvs random welcher spieler 1 und 2
    ...
    def play_game_pvs_mcts(game, time_limit = 60):
        time_limit = time_limit
        # abwechselnd mcts3 und pvs random welcher spieler 1 und 2
        alg_1_player = random.randint(1,2)
        move_count = 0
    ...
    def mcts_ab_60():
        ...
        while True:
            ...
            save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_stats_mcts_ab_60.json')
    ...
    def mcts_pvs_60():
        ...
        while True:
            ...
            # MCTS VS PVS
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_mcts_pvs(game)

            # Speichere die Statistiken in einer JSON-Datei
            save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_stats_mcts_pvs.json')
        ...
        while True:
            ...
            # PVS VS MCTS
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_pvs_mcts(game)
    ...
    def mcts_ab_30():
        ...
        while True:
            ...
            # Speichere die Statistiken in einer JSON-Datei
            save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_stats_mcts_ab_30.json')
    ...
    def mcts_pvs_30():
        ...
        while True:
            ...
            # MCTS VS PVS
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_mcts_pvs(game, time_limit=30)

            # Speichere die Statistiken in einer JSON-Datei
            save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_stats_mcts_pvs_30.json')
        ...
        while True:
            ...
            # PVS VS MCTS
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_pvs_mcts(game, time_limit=30)
