...
if __name__ == "__main__":
    ...
    # ------------ MCTS VS mtdf ------------
    def play_game_mcts_mtdf(game, time_limit = 60):
        time_limit = time_limit
        # abwechselnd mcts3 und mtdf random welcher spieler 1 und 2
    ...
    def play_game_mtdf_mcts(game, time_limit = 60):
        time_limit = time_limit
        # abwechselnd mcts3 und mtdf random welcher spieler 1 und 2
        algorithm_1_is_player_number = random.randint(1,2)
        move_count = 0
    ...
    def save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_stats.json'):
        filename_final = os.path.join(r"C:\Users\Timmy\Desktop\MCTS MTDF", filename)
        try:
    ...
    def mcts_mtdf_60():
        ...
        while True:
            ...
            # MCTS VS mtdf
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_mcts_mtdf(game)

            # Speichere die Statistiken in einer JSON-Datei
            save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_mcts_mtdf_60.json')
        ...
        while True:
            ...
            # mtdf VS MCTS
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_mtdf_mcts(game)
    ...
    def mcts_mtdf_30():
        ...
        while True:
            ...
            # MCTS VS AB
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_mcts_mtdf(game, time_limit=30)

            # Speichere die Statistiken in einer JSON-Datei
            save_game_stats(game_count, move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit, filename='game_mcts_mtdf_30.json')
        ...
        while True:
            ...
            # PVS VS MCTS
            move_count, move_stats_alg1, move_stats_alg2, iteration_count_alg1_list, iteration_count_alg2_list, winner, algo_1, algo_2, time_limit = play_game_mtdf_mcts(game, time_limit=30)
